...
class MarginalSubgraphDataset(Dataset):
    ...
    def get(self, idx):
        ...
        exclude_data = Data(x=exclude_graph_X, edge_index=exclude_graph_edge_index, pos=exclude_pos)
        include_data = Data(x=include_graph_X, edge_index=include_graph_edge_index, pos=include_pos)
...
def mc_l_shapley(coalition: list, data: Data, local_raduis: int,
    ...
    for example_idx in range(sample_num):
        ...
        # if nx.connected_components(graph.subgraph(subgraph_coalition))
